                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                          ...
                          <a href="https://poocoin.app/tokens/0x719E92ec115C4890f3f550123681229bFa2e1A75" class="btn btn-lg btn-gradient-blue btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="margin-left: 25px;background:green">CHART</a>
                        </div>
                    </div>
                </div>
            </div>
