                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                          ...
                          <a href="https://www.dexview.com/eth/0xa94D7EF8EAd1B6cB6F9e31515389FBD1beEF59D8" class="btn btn-lg btn-gradient-blue btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="margin-left: 25px;background:green">CHART</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12 text-center">
            <div style="margin-bottom:15px;border-bottom-style: solid;">
                ...
                <h4 style="font-size:24px;color:green">0.9 ETH + 98% Total Supply Tokens</h4>
            </div>
          </div>
        </div>
